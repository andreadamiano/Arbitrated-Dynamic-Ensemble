...
\puttitle{
    title={An Hybrid Ensemble Model for Time Series Prediction}, % Title of the thesis
...
\input{Machine_learning_thesis/chapters/Abstract}

%----------------------------------------------------------------------------
%	PREAMBLE PAGES: ACKNOWLEDGMENTS 
%----------------------------------------------------------------------------

\input{Machine_learning_thesis/chapters/Acknowledgments}
...
\input{Machine_learning_thesis/chapters/Introduction}

\input{Machine_learning_thesis/chapters/Literature Review}

\input{Machine_learning_thesis/chapters/Methodology}

\input{Machine_learning_thesis/chapters/Discussion of the results}

\input{Machine_learning_thesis/chapters/Results and Discussion}

\input{Machine_learning_thesis/chapters/Conclusion}
